  ...
  ProductPage({super.key}) {
    _scrollController.addListener(() {
      if (_scrollController.position.pixels ==
        ...
        log("Reached the end of the grid. Loading more...");
            ...
            Expanded(
              child: Obx(() {
                ...
                if (_productViewModel.error.isNotEmpty) {
                  return Center(
                      child: Text('Error: ${_productViewModel.error}'));
                }
                ...
                return GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    if (index == _productViewModel.products.length) {
                      if (_productViewModel.currentPage.value <
                          _productViewModel.totalPages.value) {
                        return Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              GradientText(
                                "Fetching more products. Please wait...",
                                fontSize: 12,
...
// class ProductPage extends StatelessWidget {
//   final ProductViewModel productVM = Get.put(ProductViewModel());
//   final ScrollController _scrollController = ScrollController();
...
//       body: Obx(() {
//         if (productVM.isLoading.value && productVM.products.isEmpty) {
//           return const Center(child: CircularProgressIndicator());
//         }

//         if (productVM.error.isNotEmpty) {
//           return Center(child: Text(productVM.error.value));
//         }
...
//                 itemBuilder: (context, index) {
//                   final ProductModel product = productVM.products[index];
//                   return Card(
//                     child: Column(
//                       children: [
//                         Expanded(
...
//                           child: Text(product.productTitle ?? 'No name'),
//                         ),
//                       ],
//                     ),
//                   );
